...
import Badgercropsapy from '../../components/stakingsapy/Badgercropsapy'
...
const Subpage61: React.FC = () => {  
  const farmId = "BADGER-CROPS UNI-V2 LP"
