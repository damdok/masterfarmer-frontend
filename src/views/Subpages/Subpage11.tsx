...
console.log("rows",rows)
 ...
 /*
  ...
  localStorage.setItem('lpToken', rows[0][0].lpToken)
  const lpToken = localStorage.getItem('lpToken')
  console.log('lpToken', lpToken)

  localStorage.setItem('lpTokenAddress', rows[0][0].lpTokenAddress)
  const lpTokenAddress = localStorage.getItem('lpTokenAddress')
  console.log('lpTokenAddress', lpTokenAddress)
  //var savedtemperlpTokenAddress = localStorage.getItem('lpTokenAddress')  
  //const lpTokenAddress = parseInt(savedtemperlpTokenAddress);
  //console.log('lpTokenAddress', lpTokenAddress)
  */
